    ...
    [
      require.resolve('@docusaurus/plugin-client-redirects'),
      {
        redirects: [
          ...
          { to: '/docs/biological-targets/brs1/fm3/brs1-fm3-pm5-acetylcholine-synthesis-support', from: '/docs/biological-targets/brs1/fm3/brs1-fm3-pm1-acetylcholine-synthesis-support' },
          { to: '/docs/biological-targets/brs1/fm4/brs1-fm4-pm6-neuronal-membrane-dha-incorporation', from: '/docs/biological-targets/brs1/fm4/brs1-fm4-pm1-neuronal-membrane-dha-incorporation' },
          { to: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm7-gaba-glutamate-neurotransmission-balance', from: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm1-gaba-glutamate-neurotransmission-balance' },
          { to: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm8-gaba-synthesis-capacity', from: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm2-gaba-synthesis-capacity' },
          { to: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm9-glutamate-clearance-and-recycling', from: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm3-glutamate-clearance-and-recycling' },
          { to: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm10-excitotoxicity-modulation', from: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm4-excitotoxicity-modulation' },
          ...
          { to: '/docs/biological-targets/brs1/fm3/brs1-fm3-pm5-acetylcholine-synthesis-support', from: '/docs/biological-targets/brs1/pm/brs1-pm3-acetylcholine-synthesis-support' },
          { to: '/docs/biological-targets/brs1/fm4/brs1-fm4-pm6-neuronal-membrane-dha-incorporation', from: '/docs/biological-targets/brs1/pm/brs1-pm4-neuronal-membrane-dha-incorporation' },
          { to: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm7-gaba-glutamate-neurotransmission-balance', from: '/docs/biological-targets/brs1/pm/brs1-pm6-gaba-glutamate-neurotransmission-balance' },
          { to: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm8-gaba-synthesis-capacity', from: '/docs/biological-targets/brs1/pm/brs1-pm7-gaba-synthesis-capacity' },
          { to: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm9-glutamate-clearance-and-recycling', from: '/docs/biological-targets/brs1/pm/brs1-pm8-glutamate-clearance-and-recycling' },
          { to: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm10-excitotoxicity-modulation', from: '/docs/biological-targets/brs1/pm/brs1-pm9-excitotoxicity-modulation' },
