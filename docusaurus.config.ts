    ...
    [
      require.resolve('@docusaurus/plugin-client-redirects'),
      {
        redirects: [
          ...
          { to: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm7-gaba-synthesis-capacity', from: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm2-gaba-synthesis-capacity' },
          { to: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm8-glutamate-clearance-and-recycling', from: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm3-glutamate-clearance-and-recycling' },
          { to: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm9-excitotoxicity-modulation', from: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm4-excitotoxicity-modulation' },
          ...
          { to: '/docs/biological-targets/brs4/fm2/brs4-fm2-pm3-ros-production-and-control', from: '/docs/biological-targets/brs4/fm2/brs4-fm2-pm1-ros-production-and-control' },
          { to: '/docs/biological-targets/brs4/fm2/brs4-fm2-pm4-mitochondrial-protection-redox-integrity', from: '/docs/biological-targets/brs4/fm2/brs4-fm2-pm2-mitochondrial-protection-redox-integrity' },
          { to: '/docs/biological-targets/brs4/fm3/brs4-fm3-pm5-carnitine-mediated-fat-transport', from: '/docs/biological-targets/brs4/fm3/brs4-fm3-pm1-carnitine-mediated-fat-transport' },
          { to: '/docs/biological-targets/brs4/fm4/brs4-fm4-pm6-creatine-phosphocreatine-buffer', from: '/docs/biological-targets/brs4/fm4/brs4-fm4-pm1-creatine-phosphocreatine-buffer' },
          { to: '/docs/biological-targets/brs4/fm5/brs4-fm5-pm7-mitochondrial-biogenesis', from: '/docs/biological-targets/brs4/fm5/brs4-fm5-pm1-mitochondrial-biogenesis' },
          ...
          { to: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm7-gaba-synthesis-capacity', from: '/docs/biological-targets/brs1/pm/brs1-pm7-gaba-synthesis-capacity' },
          { to: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm8-glutamate-clearance-and-recycling', from: '/docs/biological-targets/brs1/pm/brs1-pm8-glutamate-clearance-and-recycling' },
          { to: '/docs/biological-targets/brs1/fm5/brs1-fm5-pm9-excitotoxicity-modulation', from: '/docs/biological-targets/brs1/pm/brs1-pm9-excitotoxicity-modulation' },
          ...
          { to: '/docs/biological-targets/brs4/fm5/brs4-fm5-pm7-mitochondrial-biogenesis', from: '/docs/biological-targets/brs4/pm/brs4-pm2-mitochondrial-biogenesis' },
          { to: '/docs/biological-targets/brs4/fm2/brs4-fm2-pm3-ros-production-and-control', from: '/docs/biological-targets/brs4/pm/brs4-pm3-ros-production-and-control' },
          { to: '/docs/biological-targets/brs4/fm2/brs4-fm2-pm4-mitochondrial-protection-redox-integrity', from: '/docs/biological-targets/brs4/pm/brs4-pm5-mitochondrial-protection-redox-integrity' },
          { to: '/docs/biological-targets/brs4/fm4/brs4-fm4-pm6-creatine-phosphocreatine-buffer', from: '/docs/biological-targets/brs4/pm/brs4-pm6-creatine-phosphocreatine-buffer' },
          { to: '/docs/biological-targets/brs4/fm3/brs4-fm3-pm5-carnitine-mediated-fat-transport', from: '/docs/biological-targets/brs4/pm/brs4-pm7-carnitine-mediated-fat-transport' },
          ...
          { to: '/docs/biological-targets/brs1/fm5/brs1-fm5-excitatory-inhibitory-balance-gaba-glutamate-regulation', from: '/docs/biological-targets/brs1/fm/brs1-fm5-excitatory-inhibitory-balance-gaba-glutamate-regulation' },
          ...
          { to: '/docs/biological-targets/brs4/fm4/brs4-fm4-rapid-energy-buffering-and-high-demand-support', from: '/docs/biological-targets/brs4/fm/brs4-fm4-rapid-energy-buffering-and-high-demand-support' },
          { to: '/docs/biological-targets/brs4/fm5/brs4-fm5-mitochondrial-capacity-expansion-and-adaptation', from: '/docs/biological-targets/brs4/fm/brs4-fm5-mitochondrial-capacity-expansion-and-adaptation' },
