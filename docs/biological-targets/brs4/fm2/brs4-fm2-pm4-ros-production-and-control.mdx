...
parent_fm: BRS4(FM2)
parent_brs: BRS4
summary: Balance between mitochondrial ROS generation and protective buffering within the organelle.
key_constraints:
...
This PM captures mitochondrial-specific redox pressure within [BRS4(FM2) - Mitochondrial Resilience & Redox Stability](/docs/biological-targets/brs4/fm2/brs4-fm2-mitochondrial-resilience-and-redox-stability), distinct from the broader inflammatory redox layer defined in BRS3 [Packer et al., 1997; Kyriazis et al., 2022; Verlaet et al., 2019].
