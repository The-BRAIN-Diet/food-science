...
pm_id: BRS4-FM2-PM5
mission: >-
  Preserve mitochondrial membrane and enzyme integrity so organelle function
  survives oxidative and metabolic strain.
parent_fm: BRS4(FM2)
parent_brs: BRS4
summary: >-
  Protects mitochondrial membranes, enzymes, and redox systems from oxidative
  damage (cumulative wear from reactive oxygen species that can impair the
  organelle's own energy-producing machinery), preserving structural and
  functional integrity under metabolic strain. This mechanism depends on
  antioxidant substrate sufficiency reaching the mitochondria specifically,
  rather than general systemic antioxidant status alone. Because damaged
  mitochondria produce more ROS themselves, protection here helps prevent a
  self-reinforcing cycle of organelle decline.
key_constraints:
...
phenome_relationships:
  - target_phenome: Recovery Capacity
    ...
    rationale: >-
      Integrated mitochondrial membrane protection and redox integrity preserve
      energetic output when oxidative stress is elevated in paediatric ADHD —
      convergent with Verlaet glutathione/oxidative-stress findings and ADHD
      mitophagy reviews.
    references:
      - index: 1
  ...
  - target_phenome: Stress Resilience
    ...
    evidence_confidence: low-medium
    rationale: >-
      Mitophagy and mitochondrial quality-control biology reviewed in ADHD
      contexts support redox-resilience framing when oxidative insult is
      recurrent — mechanism boundary is organelle integrity, not pharmacological
      antioxidant treatment claims.
    references:
      - index: 1
        label: Almutairi et al. (2024)
        citation_key: almutairi_mitophagy_adhd_2024
