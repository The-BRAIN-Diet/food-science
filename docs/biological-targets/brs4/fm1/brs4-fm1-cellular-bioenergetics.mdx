...
<PhenomeBibLinks items={[{"href":"/docs/papers/BRAIN-Diet-References#pirinen_niacin_2020","label":"Pirinen et al. (2020)"},{"href":"/docs/papers/BRAIN-Diet-References#tardy_vitamins_2020","label":"Tardy et al. (2020)"},{"href":"/docs/papers/BRAIN-Diet-References#avgerinos_creatine_2018","label":"Avgerinos et al. (2018)"}]} />
...
<PhenomeBibLinks items={[{"href":"/docs/papers/BRAIN-Diet-References#de_guia_nad_2019","label":"de Guia et al. (2019)"},{"href":"/docs/papers/BRAIN-Diet-References#crane_coq10_2001","label":"Crane (2001)"}]} />
...
The studies below support cellular bioenergetics as an integrated FM state emerging from coordinated child PM biology — why the combined state matters for framework interpretation, not PM mechanism existence alone.

<details>
<summary><strong>Evidence highlights — cellular bioenergetics</strong></summary>
