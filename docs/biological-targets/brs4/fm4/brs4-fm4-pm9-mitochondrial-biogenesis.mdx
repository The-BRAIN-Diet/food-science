...
* Drives mitochondrial biogenesis through PGC-1α and AMPK pathways.
* Expands mitochondrial density in response to exercise signals.
* Depends on permissive substrate and cofactor support from diet.
...
<button type="button" class="brs-fm-hub-toggle" aria-expanded="false" aria-label="Expand Recovery Capacity — supports">
<span class="brs-fm-hub-chevron" aria-hidden="true"></span>
</button>
<strong class="brs-fm-hub-title">Recovery Capacity — supports</strong>
<a class="brs-fm-hub-open" href="/docs/phenomes/details/ph005-recovery-capacity" aria-label="Open page: Recovery Capacity — supports">
