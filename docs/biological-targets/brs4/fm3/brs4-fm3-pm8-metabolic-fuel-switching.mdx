...
* Switches between glucose, fat, and ketone ATP production pathways.
* Adapts energy substrate use to physiological demand.
...
<button type="button" class="brs-fm-hub-toggle" aria-expanded="false" aria-label="Expand Energy Stability Under Variable Conditions — supports">
<span class="brs-fm-hub-chevron" aria-hidden="true"></span>
</button>
<strong class="brs-fm-hub-title">Energy Stability Under Variable Conditions — supports</strong>
<a class="brs-fm-hub-open" href="/docs/phenomes/details/ph012-energy-stability-under-variable-conditions" aria-label="Open page: Energy Stability Under Variable Conditions — supports">
...
<div class="brs-fm-hub-shell">
<div class="brs-fm-hub-summary-row">
<button type="button" class="brs-fm-hub-toggle" aria-expanded="false" aria-label="Expand Metabolic Resilience — supports">
<span class="brs-fm-hub-chevron" aria-hidden="true"></span>
</button>
<strong class="brs-fm-hub-title">Metabolic Resilience — supports</strong>
<a class="brs-fm-hub-open" href="/docs/phenomes/details/ph007-metabolic-resilience" aria-label="Open page: Metabolic Resilience — supports">
<span class="brs-fm-hub-open-label">Open Page →</span>
<span class="brs-fm-hub-open-compact" aria-hidden="true">→</span>
</a>
</div>
