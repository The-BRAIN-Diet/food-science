...
phenome_relationships:
  ...
  - target_phenome: Energy Stability Under Variable Fuel Conditions
    ...
    evidence_level: mechanistic
    evidence_confidence: low
    rationale: Metabolic fuel switching governs steadiness of ATP supply across changing macronutrient availability — indirect phenome mapping from ADHD mitochondrial dysfunction framing without measured variable-fuel outcome studies.
    references:
      - index: 1
        label: Öğütlü et al. (2022)
        citation_key: ogutlu_mitochondrial_2023
...
<div class="brs-fm-hub-shell">
<div class="brs-fm-hub-summary-row">
<button type="button" class="brs-fm-hub-toggle" aria-expanded="false" aria-label="Expand Energy Stability Under Variable Fuel Conditions — indirect">
<span class="brs-fm-hub-chevron" aria-hidden="true"></span>
</button>
<strong class="brs-fm-hub-title">Energy Stability Under Variable Fuel Conditions — indirect</strong>
<a class="brs-fm-hub-open" href="/docs/phenomes/details/ph013-energy-stability-under-variable-fuel-conditions" aria-label="Open page: Energy Stability Under Variable Fuel Conditions — indirect">
<span class="brs-fm-hub-open-label">Open Page →</span>
<span class="brs-fm-hub-open-compact" aria-hidden="true">→</span>
</a>
</div>
