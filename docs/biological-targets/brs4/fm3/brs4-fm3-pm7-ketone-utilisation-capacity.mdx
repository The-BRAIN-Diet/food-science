...
<button type="button" class="brs-fm-hub-toggle" aria-expanded="false" aria-label="Expand Energy Stability Under Variable Fuel Conditions — modulates">
<span class="brs-fm-hub-chevron" aria-hidden="true"></span>
</button>
<strong class="brs-fm-hub-title">Energy Stability Under Variable Fuel Conditions — modulates</strong>
<a class="brs-fm-hub-open" href="/docs/phenomes/details/ph013-energy-stability-under-variable-fuel-conditions" aria-label="Open page: Energy Stability Under Variable Fuel Conditions — modulates">
