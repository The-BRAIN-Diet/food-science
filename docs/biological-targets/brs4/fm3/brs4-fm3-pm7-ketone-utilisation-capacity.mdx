...
parent_fm: BRS4(FM3)
parent_brs: BRS4
summary: 'Capacity to transport, metabolise, and utilise ketone bodies as alternative mitochondrial energy substrates when glucose availability or metabolic conditions change.'
key_constraints:
