...
This PM captures mitochondrial-specific redox pressure within [BRS4(FM2) - Mitochondrial Resilience & Redox Stability](/docs/biological-targets/brs4/fm/brs4-fm2-mitochondrial-resilience-and-redox-stability), distinct from the broader inflammatory redox layer defined in BRS3 [1][2][3].
...
This PM stays mitochondrial in scope, while the more distributed inflammatory and systemic redox pattern remains handled in [BRS3(PM3) - ROS Generation vs Clearance Balance](/docs/biological-targets/brs3/pm/brs3-pm3-ros-generation-vs-clearance-balance).
