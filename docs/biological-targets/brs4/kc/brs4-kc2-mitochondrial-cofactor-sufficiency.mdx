...
**Why it remains emerging:** Brain creatine pools are shaped primarily by endogenous synthesis and transport rather than dietary creatine by default; supplementation is a conditional adjunct for selected high-demand or low-intake contexts, not a shared indispensable dietary requirement for this KC.
...
- Creatine monohydrate — emerging / condition-specific phosphocreatine buffering support (see §4); [Avgerinos et al. (2018) — Effects of creatine supplementation on cognitive function](/docs/papers/BRAIN-Diet-References#avgerinos_creatine_2018)
- [Tardy et al. (2020) — A Narrative Review of the Biochemical and Clinical Evidence](/docs/papers/BRAIN-Diet-References#tardy_vitamins_2020)
