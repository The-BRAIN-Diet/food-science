...
These pressures may impair [BRS4(PM2) — Mitochondrial Biogenesis](/docs/biological-targets/brs4/pm/brs4-pm2-mitochondrial-biogenesis). At the FM level, this may shift BRS4(FM5) toward reduced mitochondrial capacity expansion & adaptation performance.
