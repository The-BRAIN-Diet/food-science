...
These pressures may impair [BRS3(PM2) — Nrf2-ARE Antioxidant Activation](/docs/biological-targets/brs3/pm/brs3-pm2-nrf2-are-antioxidant-activation), weaken [BRS3(PM3) — ROS Generation vs Clearance Balance](/docs/biological-targets/brs3/pm/brs3-pm3-ros-generation-vs-clearance-balance), reduce the effectiveness of [BRS3(PM5) — Lipid Peroxidation Control](/docs/biological-targets/brs3/pm/brs3-pm5-lipid-peroxidation-control), and compromise [BRS3(PM8) — Antioxidant Network Recycling](/docs/biological-targets/brs3/pm/brs3-pm8-antioxidant-network-recycling). At the FM level, this may shift BRS3(FM2) toward reduced antioxidant defense capacity performance.
