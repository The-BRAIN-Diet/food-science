...
kc_id: BRS3(KC1)
parent_brs: BRS3
summary: 'Helps ensure availability of antioxidant substrates and precursor compounds required to support endogenous antioxidant defence, redox buffering, and limitation of oxidative damage.'
references:
  - >-
...
* Constrains Nrf2 activation and antioxidant network recycling when depleted.
* Supports redox buffering across BRS3(FM2) mechanisms.
* Links fruit, vegetable, and polyphenol intake to endogenous defence capacity.
