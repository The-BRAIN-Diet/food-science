...
- Population and dietary-pattern associations link habitual intake patterns to IL-6, TNF-α, and CRP-linked inflammatory tone → [Brown et al., 2025] [Brown et al., 2025]
- Stress–diet interactions illustrate that cytokine readouts shift with combined metabolic and behavioural context, supporting pattern-based rather than single-nutrient framing → [Chang et al., 2020] [Chang et al., 2020]
