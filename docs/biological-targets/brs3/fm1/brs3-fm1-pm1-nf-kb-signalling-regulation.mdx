...
Downstream cytokine-network expression is handled by [BRS3-FM3-PM7 - Cytokine Network Modulation](/docs/biological-targets/brs3/fm3/brs3-fm3-pm7-cytokine-network-modulation). Gut-derived endotoxin load is represented by [BRS3-FM1-PM2 - Gut-Derived Inflammatory Signalling](/docs/biological-targets/brs3/fm1/brs3-fm1-pm2-gut-derived-inflammatory-signalling). Endogenous antioxidant induction and net redox balance belong to [BRS3-FM2-PM5 - Nrf2-ARE Antioxidant Activation](/docs/biological-targets/brs3/fm2/brs3-fm2-pm3-nrf2-are-antioxidant-activation) and [BRS3-FM2-PM6 - ROS Generation vs Clearance Balance](/docs/biological-targets/brs3/fm2/brs3-fm2-pm4-ros-generation-vs-clearance-balance).
...
<details>
<summary><strong>Quercetin and polyphenol synergy</strong></summary>
