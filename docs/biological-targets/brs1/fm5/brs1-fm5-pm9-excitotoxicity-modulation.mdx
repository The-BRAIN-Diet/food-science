...
references:
  - >-
    [1] [Clerc et al.
    (2013)](/docs/papers/BRAIN-Diet-References#clerc_magnesium_2013)
  - >-
    [2] [Mamiya et al.
...
BRS1-FM5-PM9 extends [BRS1-FM5-PM8](/docs/biological-targets/brs1/fm5/brs1-fm5-pm8-glutamate-clearance-and-recycling) clearance biology toward **stress and injury prevention**, with connected mechanisms (section 5.3) to inflammatory and mitochondrial support layers.

Together, BRS1-FM5-PM9 links dietary magnesium, omega-3, and antioxidant patterns to reduction of excitotoxic burden in the E/I cluster.
