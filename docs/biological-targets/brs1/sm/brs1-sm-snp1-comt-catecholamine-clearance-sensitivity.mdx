...
COMT metabolises catecholamines; lower activity genotypes are sometimes discussed alongside slower clearance and greater sensitivity to dietary tyrosine and meal timing. [BRS1-FM1-PM1](/docs/biological-targets/brs1/fm1/brs1-fm1-pm1-amino-acid-availability-and-prioritisation) and [BRS1-FM2-PM4](/docs/biological-targets/brs1/fm2/brs1-fm2-pm4-lat1-competitive-transport-modulation) remain the authoritative mechanism definitions; this SM applies variant context to their joint interpretation within [BRS1(FM1)](/docs/biological-targets/brs1/fm1/brs1-fm1-monoaminergic-function).
...
- LNAA-aware meal pairing (carbohydrate quality, protein completeness) per [BRS1-FM2-PM4](/docs/biological-targets/brs1/fm2/brs1-fm2-pm4-lat1-competitive-transport-modulation) (meal-pattern lever).
