...
parent_brs: BRS1
summary: >-
  Variant-sensitive overlay on COMT-related catecholamine clearance
  interpretation: connects amino-acid availability/prioritisation and LAT1
  transport PMs to meal-level resilience without deterministic genotype claims
...
COMT metabolises catecholamines; lower activity genotypes are sometimes discussed alongside slower clearance and greater sensitivity to dietary tyrosine and meal timing. [BRS1-FM1-PM1](/docs/biological-targets/brs1/fm1/brs1-fm1-pm1-amino-acid-availability-and-prioritisation) and [BRS1-FM2-PM3](/docs/biological-targets/brs1/fm2/brs1-fm2-pm3-lat1-competitive-transport-modulation) remain the authoritative mechanism definitions; this SM applies variant context to their joint interpretation within [BRS1(FM1)](/docs/biological-targets/brs1/fm1/brs1-fm1-catecholaminergic-function).
...
[BRS1-FM1-PM2](/docs/biological-targets/brs1/fm1/brs1-fm1-pm2-noradrenergic-signalling-attention-executive-modulation) links noradrenergic attention modulation; variant context may inform how aggressively to rely on tyrosine-forward meals versus balanced LNAA patterns.
...
- LNAA-aware meal pairing (carbohydrate quality, protein completeness) per [BRS1-FM2-PM3](/docs/biological-targets/brs1/fm2/brs1-fm2-pm3-lat1-competitive-transport-modulation) (meal-pattern lever).
