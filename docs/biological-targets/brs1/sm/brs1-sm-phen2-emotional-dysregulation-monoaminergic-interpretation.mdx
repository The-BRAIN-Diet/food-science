...
parent_brs: BRS1
summary: >-
  Phenotype-sensitive overlay interpreting emotional dysregulation through
  monoamine precursor, transport, and signalling biology — grounded in BRS1
...
connected_pms:
  ...
  - id: BRS1-FM2-PM4
    ...
    href: >-
      /docs/biological-targets/brs1/fm2/brs1-fm2-pm4-lat1-competitive-transport-modulation
  - id: BRS1-FM1-PM2
  ...
  - id: BRS1-FM1-PM3
    ...
    href: >-
      /docs/biological-targets/brs1/fm1/brs1-fm1-pm3-serotonergic-signalling-regulation
connected_fms:
  - id: BRS1(FM1)
...
This SM interprets how amino-acid availability, dopaminergic, noradrenergic, and serotonergic signalling, together with LNAA competitive transport dynamics, may influence emotional regulation phenotypes. The [BRS1 hub](/docs/biological-targets/neurotransmitter-regulation) retains brief ADHD linkage; this page holds phenotype interpretation grounded in connected PMs/FMs/KCs. This page does not assert biomarkers, diagnoses, or treatment efficacy.
...
Serotonin sits at the intersection of ADHD hyperactivity/impulsivity and emotional dysregulation phenotype interpretation—not a single-transmitter story in isolation. [BRS1-FM1-PM1](/docs/biological-targets/brs1/fm1/brs1-fm1-pm1-amino-acid-availability-and-prioritisation) establishes meal-level amino-acid pool sufficiency and prioritisation; [BRS1-FM2-PM4](/docs/biological-targets/brs1/fm2/brs1-fm2-pm4-lat1-competitive-transport-modulation) and [BRS1(FM2)](/docs/biological-targets/brs1/fm2/brs1-fm2-glycaemic-modulation-of-neurotransmitter-balance) shape LNAA partitioning and transport bias (tryptophan versus tyrosine entry); [BRS1-FM1-PM3](/docs/biological-targets/brs1/fm1/brs1-fm1-pm3-serotonergic-signalling-regulation) covers serotonergic signalling regulation; and [BRS1-FM1-PM2](/docs/biological-targets/brs1/fm1/brs1-fm1-pm2-noradrenergic-signalling-attention-executive-modulation) links noradrenergic attention context. BRS1(SM-PHEN2) applies that stable biology to emotional-regulation interpretation without redefining PM mechanisms.
...
[BRS1-FM1-PM2](/docs/biological-targets/brs1/fm1/brs1-fm1-pm2-noradrenergic-signalling-attention-executive-modulation) provides noradrenergic attention/executive context within [BRS1(FM1)](/docs/biological-targets/brs1/fm1/brs1-fm1-monoaminergic-function). This SM connects those mechanisms to emotional dysregulation framing — supportive dietary context only, not pharmacologic substitution.
