...
Serotonin sits at the intersection of ADHD hyperactivity/impulsivity and emotional dysregulation phenotype interpretation—not a single-transmitter story in isolation. [BRS1-FM1-PM1](/docs/biological-targets/brs1/fm1/brs1-fm1-pm1-amino-acid-availability-and-prioritisation) establishes meal-level amino-acid pool sufficiency and prioritisation; [BRS1-FM2-PM4](/docs/biological-targets/brs1/fm2/brs1-fm2-pm4-lat1-competitive-transport-modulation) and [BRS1(FM2)](/docs/biological-targets/brs1/fm2/brs1-fm2-glycaemic-modulation-of-neurotransmitter-balance) shape LNAA partitioning and transport bias (tryptophan versus tyrosine entry); [BRS1-FM1-PM2](/docs/biological-targets/brs1/fm1/brs1-fm1-pm2-noradrenergic-signalling-attention-executive-modulation) links noradrenergic attention context. BRS1(SM-PHEN2) applies that stable biology to emotional-regulation interpretation without redefining PM mechanisms.
