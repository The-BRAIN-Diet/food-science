...
* Helps limit neural stress risk when glutamatergic drive becomes excessive.
* Supports long-term cognitive and regulatory stability under excitatory load.
* Connects dietary amino-acid context to endogenous excitatory buffering capacity.
