...
parent_fm: BRS1(FM4)
parent_brs: BRS1
summary: Helps protect the brain from excessive excitatory stress when glutamatergic drive becomes too strong.
key_constraints:
...
Helps protect the brain from excessive excitatory stress when glutamatergic drive becomes too strong. Modulating excitotoxic pressure supports neural stability and cognitive regulation over time.
