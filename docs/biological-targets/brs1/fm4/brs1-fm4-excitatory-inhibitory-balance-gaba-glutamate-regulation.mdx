...
<details>
<summary><strong>Glutamate and attention in ADHD</strong></summary>

- **Confidence:** low-medium
- **Evidence Level:** mechanistic
- **Rationale:** Low glutamate in critical brain areas correlates with low Barkley attention scale scores in adults with ADHD, supporting glutamatergic involvement in excitatory–inhibitory balance relevant to attention [Maltezos et al., 2014].
- **Key References:**

<PhenomeBibLinks items={[{"href":"/docs/papers/BRAIN-Diet-References#maltezos_glutamateglutamine_2014","label":"Maltezos et al. (2014)","dataLevel":"Human Study"}]} />
