...
* Converts glutamate to GABA to strengthen inhibitory calming signals.
* Supports resistance to overstimulation and sensory overload.
* Depends on cofactor and amino-acid context from broader dietary patterns.
