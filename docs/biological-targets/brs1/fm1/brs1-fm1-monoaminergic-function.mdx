...
<details>
<summary><strong>Dopaminergic dysfunction in ADHD</strong></summary>

- **Confidence:** low-medium
- **Evidence Level:** mechanistic
- **Rationale:** Dopaminergic dysfunction in ADHD does not support a simple global hypo-dopaminergic model; alterations vary by subtype, developmental stage, and brain region [MacDonald et al., 2024].
- **Key References:**

<PhenomeBibLinks items={[{"href":"/docs/papers/BRAIN-Diet-References#macdonald_dopamine_2024","label":"MacDonald et al. (2024)","dataLevel":"Mechanistic"}]} />

</details>

<details>
<summary><strong>Dopamine, attention, and default-mode network switching</strong></summary>

- **Confidence:** low-medium
- **Evidence Level:** mechanistic
- **Rationale:** Dopamine shapes attention and default-mode to executive-network switching relevant to monoaminergic attention pathways [Santos et al., 2019].
- **Key References:**

<PhenomeBibLinks items={[{"href":"/docs/papers/BRAIN-Diet-References#santos_como_2019","label":"Santos et al. (2019)","dataLevel":"Mechanistic"}]} />
