...
Although this PM focuses on amino-acid availability, many protein-rich foods also contribute nutrients relevant to [BRS2 — Methylation & One-Carbon Metabolism](/docs/biological-targets/methylation-one-carbon-metabolism), [BRS4 — Mitochondrial Function & Bioenergetics](/docs/biological-targets/mitochondrial-function-bioenergetics), and broader antioxidant and metabolic regulation. The framework distinguishes the amino-acid substrate role represented by BRS1-FM1-PM1 from those additional cross-BRS functions.
