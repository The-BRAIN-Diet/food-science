...
| --- | --- | --- |
| [BRS1(PM1)](/docs/biological-targets/brs1/pm/brs1-pm1-tyrosine-tryptophan-precursor-supply) | B6, iron, folate, vitamin C | choline, dietary protein, tryptophan, tyrosine, LNAAs ([KC1](/docs/biological-targets/brs1/kc/brs1-kc1-amino-acid-substrate-sufficiency)) |
