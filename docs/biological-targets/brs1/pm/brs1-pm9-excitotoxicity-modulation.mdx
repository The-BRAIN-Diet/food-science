...
Maintenance of excitatory–inhibitory stability depends not only on precursor availability; while [BRS1(PM1)](/docs/biological-targets/brs1/pm/brs1-pm1-amino-acid-availability-and-prioritisation) supports meal-level amino-acid substrate context, much of the regulatory activity is endogenous and only indirectly supported by diet.
