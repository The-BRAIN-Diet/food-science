...
BRS1(PM2) therefore governs **transport bias** at the barrier, while [BRS1(PM1)](/docs/biological-targets/brs1/pm/brs1-pm1-tyrosine-tryptophan-precursor-supply) governs whether adequate precursor substrate is present in the first place.
