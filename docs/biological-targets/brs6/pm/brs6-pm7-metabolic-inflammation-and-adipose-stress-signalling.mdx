...
- Evidence/Notes (Column N): Important manuscript bridge between metabolic dysfunction, inflammation, and brain-relevant stress state.
...
| Dose Target / Requirement (Column J) | `Pattern-level change over days to weeks; no single food dose captures it` |
