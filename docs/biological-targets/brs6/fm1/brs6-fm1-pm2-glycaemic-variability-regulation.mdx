...
Acute glucose fluctuations have been shown to induce oxidative stress more strongly than sustained hyperglycaemia, supporting a mechanistic relationship between oscillatory glucose exposure, cellular stress signalling, and downstream metabolic dysfunction → [Monnier et al., 2006] [Monnier et al., 2006]
