...
Dietary composition and food structure directly influence glucose appearance kinetics. Higher fibre intake reduces post-prandial glucose responses through delayed gastric emptying and attenuated glucose absorption → [Reynolds et al., 2019] [Reynolds et al., 2019]
...
Acetic acid exposure has also been shown to reduce post-prandial glycaemia and improve insulin sensitivity, further supporting the role of acute meal-level modifiers in regulating glucose appearance dynamics → [Johnston et al., 2004] [Johnston et al., 2004]
