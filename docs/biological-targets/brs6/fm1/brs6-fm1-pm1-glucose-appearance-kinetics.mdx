...
parent_brs: BRS6
summary: >-
  Regulation of the rate and temporal profile of glucose appearance following
  feeding through digestion kinetics, gastric emptying, intestinal absorption,
  food structure, and meal-context effects.
key_constraints:
