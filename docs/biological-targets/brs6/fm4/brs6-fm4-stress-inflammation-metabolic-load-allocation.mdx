...
parent_brs: BRS6
summary: >-
  Integrated regulation of metabolic-inflammatory load and stress-linked
  appetite–reward signalling, influencing whole-body resource allocation and
  brain-relevant energy/stress state.
mechanisms_covered:
  - id: BRS6-FM4-PM8
    name: Metabolic Inflammation & Adipose Stress Signalling
    href: >-
      /docs/biological-targets/brs6/fm4/brs6-fm4-pm8-metabolic-inflammation-and-adipose-stress-signalling
  - id: BRS6-FM4-PM9
    name: Stress-Induced Appetite / Reward Drive Modulation
    href: >-
      /docs/biological-targets/brs6/fm4/brs6-fm4-pm9-stress-induced-appetite-reward-drive-modulation
key_constraints:
  - id: BRS6(KC1)
