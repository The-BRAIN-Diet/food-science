...
parent_fm: BRS2(FM3)
parent_brs: BRS2
summary: 'Helps build phospholipid membranes that carry omega-3 fatty acids toward the brain, supporting membrane flexibility and cell signalling. This connects methylation capacity and B-vitamin status to the membrane chemistry that underpins brain function.'
key_constraints:
