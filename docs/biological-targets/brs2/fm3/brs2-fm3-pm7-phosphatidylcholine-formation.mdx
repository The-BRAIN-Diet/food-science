...
<details>
<summary><strong>Phosphatidylcholine formation — mechanistic detail</strong></summary>
...
<details>
<summary><strong>Evidence highlights — phospholipid methylation and B-vitamin × omega-3 synergy</strong></summary>
...
This positions BRS2-FM3-PM7 as the methylation-dependent bridge between upstream one-carbon support and downstream brain omega-3 delivery represented in [BRS1-FM3-PM6](/docs/biological-targets/brs1/fm3/brs1-fm3-pm6-neuronal-membrane-dha-incorporation).
