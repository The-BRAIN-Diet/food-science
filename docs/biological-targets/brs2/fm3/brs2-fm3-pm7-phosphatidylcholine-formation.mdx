...
pm_id: BRS2-FM3-PM7
mission: >-
  Form phosphatidylcholine membranes that carry omega-3 fats toward the brain
  and support neural signalling competence.
parent_fm: BRS2(FM3)
parent_brs: BRS2
summary: >-
  Forms phosphatidylcholine (a methylation-dependent membrane phospholipid) that
  carries omega-3 fatty acids toward the brain and supports overall membrane
  structure and flexibility. This mechanism connects methylation capacity and
  B-vitamin status directly to the lipid environment in which neural signalling
  occurs, rather than acting as an independent lipid pathway. When methylation
  efficiency is constrained, omega-3 carriage and membrane phospholipid quality
  can both be affected downstream.
key_constraints:
...
references:
  - >-
    [Vance et al. (2014) — Physiological Roles of Phosphatidylethanolamine
    N-methyltransferase](/docs/papers/BRAIN-Diet-References#vance_phospholipid_2014)
  - >-
...
phenome_relationships:
  - target_phenome: Cognitive Clarity
    ...
    rationale: >-
      B-vitamin cognitive effects depend on omega-3 status (VITACOG reanalysis);
      phospholipid methylation couples homocysteine regulation to
      omega-3-enriched PC delivery toward the brain. PEMT pathway biology and
      phospholipid-bound DHA accretion evidence support cognitive-clarity
      framework translation — ADHD-specific cognitive-clarity trials on PC
      formation remain limited (biology > evidence gap).
    references:
      - index: 1
  ...
  - target_phenome: Focus / Attention Stability
    ...
    evidence_confidence: low-medium
    rationale: >-
      Dietary patterns rich in folate and omega-3 associated with reduced ADHD
      symptoms and choline implicated across neurodevelopmental disorders link
      methylation–membrane coupling to attention-relevant nutrient patterns. PC
      formation is the methylation-dependent bridge — direct ADHD
      attention-outcome trials on PEMT/PC biology remain sparse.
    references:
      - index: 1
        label: Oulhaj et al. (2016)
        citation_key: oulhaj_omega-3_2016
