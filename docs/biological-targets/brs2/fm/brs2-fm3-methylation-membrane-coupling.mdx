...
| [BRS2(PM7)](/docs/biological-targets/brs2/pm/brs2-pm7-phospholipid-methylation) | magnesium *(indirect — supports SAMe-dependent phospholipid methylation)* | B12, betaine, choline, folate ([KC1](/docs/biological-targets/brs2/kc/brs2-kc1-methyl-donor-sufficiency)); amino acid support, cysteine, glycine, methionine ([KC2](/docs/biological-targets/brs2/kc/brs2-kc2-amino-acid-substrate-sufficiency)) |
