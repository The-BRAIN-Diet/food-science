...
kc_id: BRS2(KC2)
parent_brs: BRS2
summary: 'Helps ensure sufficient sulfur amino acid and methionine substrates to sustain methylation cycling, transsulfuration, and glutathione production. This shared pool supports both methyl-group metabolism and antioxidant defence.'
hide_title: true
---
