...
The studies below support methylation cycle efficiency as an integrated FM state emerging from coordinated child PM biology — why the combined state matters for framework interpretation, not PM mechanism existence alone.

<details>
<summary><strong>Evidence highlights — methylation cycle efficiency</strong></summary>
