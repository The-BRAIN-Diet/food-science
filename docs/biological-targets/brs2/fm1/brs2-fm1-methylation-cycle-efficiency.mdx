...
summary: 'Maintains one-carbon cycle efficiency by coordinating homocysteine recycling, SAMe production, and methylation capacity across brain-relevant pathways.'
mechanisms_covered:
  - id: BRS2-FM1-PM1
...
- **Relied upon by:** [BRS2-FM1-PM1](/docs/biological-targets/brs2/fm1/brs2-fm1-pm1-folate-b12-dependent-homocysteine-remethylation), [BRS2-FM1-PM2](/docs/biological-targets/brs2/fm1/brs2-fm1-pm2-betaine-bhmt-remethylation), [BRS2-FM1-PM4](/docs/biological-targets/brs2/fm1/brs2-fm1-pm4-methionine-cycle-flux)
...
<div class="brs-fm-hub-panel">
- **Relied upon by:** [BRS2-FM1-PM3](/docs/biological-targets/brs2/fm1/brs2-fm1-pm3-same-synthesis), [BRS2-FM1-PM4](/docs/biological-targets/brs2/fm1/brs2-fm1-pm4-methionine-cycle-flux)
- Maintain sulfur amino-acid substrate adequacy and balance to support methionine-cycle flux, transsulfuration, and glutathione-linked protection — without treating methionine as a nutrient to maximise.
</div>
</div>
</div>
...
<button type="button" class="brs-fm-hub-summary" aria-expanded="false">
<span class="brs-fm-hub-chevron" aria-hidden="true"></span>
<strong>MAT converts methionine and ATP into SAMe</strong>
</button>
<div class="brs-fm-hub-panel" hidden>
...
<PhenomeBibLinks items={[{"href":"/docs/papers/BRAIN-Diet-References#bailey_human_mat2a_2021","label":"Bailey et al. (2021)","dataLevel":"Cellular / Molecular"},{"href":"/docs/papers/BRAIN-Diet-References#murray_crystallography_2016","label":"Murray et al. (2016)","dataLevel":"Cellular / Molecular"}]} />
</div>
</div>
</div>
