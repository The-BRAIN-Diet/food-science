...
parent_fm: BRS2(FM1)
parent_brs: BRS2
summary: 'Alternative betaine-dependent recycling of homocysteine to methionine through the BHMT pathway, supporting methyl-donor availability and SAMe synthesis when one-carbon demands increase.'
key_constraints:
