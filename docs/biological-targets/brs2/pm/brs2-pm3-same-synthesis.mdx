...
timing_specific: 'Yes'
dose_sensitivity: Methionine adequacy + ATP status
references:
...
- magnesium-rich greens/seeds → magnesium
...
| Substance / Nutrient Signals | methionine; magnesium | Substrate and cofactor signals for this PM. |
