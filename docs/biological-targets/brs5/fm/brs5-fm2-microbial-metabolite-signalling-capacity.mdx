...
These pressures may impair [BRS5(PM1) — Microbial Ecological Turnover & Competitive Selection](/docs/biological-targets/brs5/pm/brs5-pm1-microbial-ecological-turnover-and-competitive-selection), weaken [BRS5(PM2) — SCFA Production & Signalling](/docs/biological-targets/brs5/pm/brs5-pm2-scfa-production-and-signalling), and reduce the effectiveness of [BRS5(PM8) — Polyphenol Biotransformation & Mitochondrial-Relevant Metabolite Generation](/docs/biological-targets/brs5/pm/brs5-pm8-polyphenol-biotransformation-and-mitochondrial-relevant-metabolite-generation). At the FM level, this may shift BRS5(FM2) toward reduced microbial metabolite signalling capacity performance.
