...
The studies below support gut barrier integrity & immune interface as an integrated FM state emerging from coordinated child PM biology — why the combined state matters for framework interpretation, not PM mechanism existence alone.

<details>
<summary><strong>Evidence highlights — gut barrier integrity immune interface</strong></summary>
