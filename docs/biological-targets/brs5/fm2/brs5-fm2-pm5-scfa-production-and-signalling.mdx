...
pm_id: BRS5-FM2-PM5
mission: >-
  Maintain short-chain fatty acid production and signalling that supports gut
  barrier and brain communication.
summary: >-
  Short-chain fatty acids (beneficial compounds made when gut bacteria ferment
  fibre) include butyrate, propionate and acetate. They help nourish the gut
  lining, modulate immune tone and send signals relevant to brain function. When
  fermentable fibre intake is low or inconsistent, SCFA production may decline
  and with it this signalling capacity.
parent_fm: BRS5(FM2)
parent_brs: BRS5
key_constraints:
...
references:
  ...
  - >-
    [Hoyles et al. (2018) — Protective Effects of Propionate Upon the
    Blood-brain
    Barrier](/docs/papers/BRAIN-Diet-References#hoyles_microbiome-host_2018)
  - >-
  ...
  - >-
    [Steckler et al. (2024) — Disrupted Gut Harmony in ADHD: Dysbiosis and
    Decreased Short-Chain Fatty
...
phenome_relationships:
  - target_phenome: Focus / Attention Stability
    ...
    rationale: >-
      ADHD cohorts showed lower faecal SCFA levels including acetic, propionic,
      isobutyric, isovaleric, and valeric acids versus controls — positioning
      microbial SCFA production and signalling as a direct observational anchor
      for attention-relevant gut metabolite biology.
    references:
      - index: 1
  ...
  - target_phenome: Emotional Regulation
    ...
    rationale: >-
      SCFA gut–brain signalling may intersect affective regulation through vagal
      and immune pathways — indirect translational framing from ADHD SCFA
      deficit observation without emotional-outcome intervention trials.
    references:
      - index: 1
        label: Steckler et al. (2024)
        citation_key: steckler_disrupted_2024
