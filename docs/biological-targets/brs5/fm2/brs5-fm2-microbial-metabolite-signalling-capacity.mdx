...
The studies below support microbial metabolite signalling capacity as an integrated FM state emerging from coordinated child PM biology — why the combined state matters for framework interpretation, not PM mechanism existence alone.

<details>
<summary><strong>Evidence highlights — microbial metabolite signalling capacity</strong></summary>
