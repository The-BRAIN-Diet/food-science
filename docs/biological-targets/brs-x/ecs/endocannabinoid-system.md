...
<li class="brs-hub-lifestyle-priority"><p class="brs-hub-lifestyle-text"><strong>Maintain regular meal timing</strong> to support steady dietary entry into endocannabinoid precursor pools across the day.</p><p class="brs-hub-lifestyle-supports"><span class="brs-hub-lifestyle-supports-label">Supports:</span> <span class="brs-hub-lever-pms"><a href="/docs/biological-targets/brs-x/ecs/fm1/brs-x-ecs-pm1-nape-nae-biosynthesis-capacity" class="brs-hub-lever-pm">BRS-X(ECS-PM1)</a> <a href="/docs/biological-targets/brs-x/ecs/fm1/brs-x-ecs-pm2-omega-3-derived-endocannabinoidome-signalling" class="brs-hub-lever-pm">BRS-X(ECS-PM2)</a></span></p></li>
</ul>
