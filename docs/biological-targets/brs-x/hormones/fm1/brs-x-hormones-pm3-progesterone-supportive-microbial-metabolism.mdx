...
summary: 'Microbial and metabolite-linked support for progesterone-related hormonal stability, potentially involving butyrate-producing organisms such as Faecalibacterium prausnitzii and Roseburia.'
key_constraints:
...
<PhenomeBibLinks items={[{"href":"/docs/papers/BRAIN-Diet-References#dafflitto_sex_hormone_gut_microbiota_2022","label":"d'Afflitto et al. (2022)"}]} />
...
Faecalibacterium prausnitzii, Roseburia, and related butyrate-producing organisms may support anti-inflammatory and barrier-supportive contexts that intersect with endocrine stability → [d'Afflitto et al., 2022] [d'Afflitto et al., 2022]
