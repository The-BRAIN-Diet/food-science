...
- SAMe-dependent phospholipid methylation via PEMT converts phosphatidylethanolamine to phosphatidylcholine, altering membrane structure and fluidity [Vance 2014](/docs/papers/BRAIN-Diet-References#vance_phospholipid_2014)
- Reduced gamma-band activity has been reported in ADHD [Wilson et al. 2012](/docs/papers/BRAIN-Diet-References#wilson_gamma-frequency_2012)
