...
title: Caprylic Triglyceride (Trioctanoin)
sidebar_label: Caprylic Triglyceride (C8)
description: Medium-chain triglyceride (C8) providing rapid brain energy via ketone production
tags:
  - Substance
  - Nutrient
  - Fatty Acid
...
<SubstanceRecipes tag="Caprylic Triglyceride" />

## Foods

<SubstanceFoods tag="Caprylic Triglyceride" />

## Biological Mechanisms and Implications

<SubstanceMatrix tag="Caprylic Triglyceride" />
