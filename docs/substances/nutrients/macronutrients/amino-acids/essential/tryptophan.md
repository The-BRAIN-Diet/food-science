...
- Tryptophan has been linked to reduced anxiety, improved mood, and lower depressive symptoms, but shows very limited benefit for ADHD symptoms [Aquili 2020](/docs/papers/BRAIN-Diet-References#aquili_role_2020) [Dinu et al. 2023](/docs/papers/BRAIN-Diet-References#dinu_effects_2023)
...
- Carbohydrate type matters: sucrose produced a larger rise in tryptophan:LNAA (+34%) than starch (+20%), consistent with higher-GI carbohydrates more strongly enhancing brain tryptophan bioavailability [Lyons and Truswell 1988](/docs/papers/BRAIN-Diet-References#lyons_serotonin_1988)
