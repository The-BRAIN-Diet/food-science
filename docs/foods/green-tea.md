...
Green tea provides catechins (especially EGCG), L-theanine, and polyphenols that support cognitive function, antioxidant defenses, and metabolic health.
...
- "Green tea catechins (e.g., EGCG, EGC)" mentioned in Green Mediterranean Diet study
...
- Steep at lower temperatures to preserve catechins
- Can reduce non-heme iron absorption if taken with meals
- Space ≥1 hour from iron-rich meals or add lemon (vitamin C)
