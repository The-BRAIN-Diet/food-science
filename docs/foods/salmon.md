...
<TagList tag="Salmon" filter="recipes" />
...
- Most research showing brain function improvements lean towards higher ratio of EPA to DHA (e.g., 2:1 ratio or higher) with DHA having a more structural role in the brain and EPA with a more functional role [McNamara and Carlson 2006](/docs/papers/BRAIN-Diet-References#mcnamara_role_2006) [Stonehouse et al. 2013](/docs/papers/BRAIN-Diet-References#stonehouse_dha_2013)
