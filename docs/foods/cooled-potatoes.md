...
Potatoes that are cooked and then cooled develop resistant starch through retrogradation, providing prebiotic fiber that supports gut microbiome and SCFA production.
...
- Cook potatoes, then cool (refrigerate) to form resistant starch
- Reheating does not reverse resistant starch formation
- Supports butyrate production via gut fermentation
- Lower glycemic response compared to hot potatoes
