...
Walnuts provide plant-based omega-3 (ALA), polyphenols, and ellagitannins that can be converted to urolithin A by gut bacteria, supporting mitochondrial health and cognitive function.
...
- Mentioned as source of plant-based omega-3
- Part of Mediterranean diet pattern

## Preparation Notes

- Best consumed raw to preserve omega-3s
- Soaking may improve digestibility
- Pair with other omega-3 sources for optimal DHA status
