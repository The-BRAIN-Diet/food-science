...
nutrition_supplementary_sources:
  - key: delphinidin_glycosides_nasunin
    label: Delphinidin
    status: Present as glycosides (nasunin) — quantity not established
    amount_display: Present as glycosides (nasunin) — quantity not established
    notes: >-
