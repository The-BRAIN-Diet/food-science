...
Compared with the existing [`Cocoa`](/docs/foods/cocoa) page, this page is intentionally positioned as the minimally processed form. The practical distinction is processing intensity: cacao powder is typically less processed, while cocoa products are often more processed (and may be alkalised), which can alter flavanol content and sensory profile [1].
...
<FoodRecipes tag="Cacao Powder" />

## References

[1] Cocoa and Cacao: What is the difference in processing context and nutrition framing? [WebMD Editorial Team, 2025](https://www.webmd.com/diet/difference-between-cocoa-and-cacao)
