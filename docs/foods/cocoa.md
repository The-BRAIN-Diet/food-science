...
This page covers **cocoa (processed cocoa product context)**. For the minimally processed, less-alkalised form used in this framework as a distinct ingredient, see [`Cacao Powder`](/docs/foods/cacao-powder).
