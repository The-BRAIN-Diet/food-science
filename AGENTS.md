...
Each markdown file should have a list_image entry. Where this is a substance, use the inchi image from `/static/img/inchi`.
...
**Note:** Do NOT create a `sidebars.ts` file. Docusaurus uses autogenerated sidebars based on the directory structure. The sidebar is automatically generated from the folder hierarchy in the `docs` directory.

**Note:** Use index.md over README.md.
