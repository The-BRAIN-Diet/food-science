...
**Dietary and lifestyle guidance** belongs on the hub **Dietary and Lifestyle Levers** section (currently ADHD-oriented as the first mapped therapeutic area). Do **not** duplicate diet or lifestyle prose inside the ADHD dropdown — other therapeutic areas may carry their own TA-specific dietary notes in future dropdowns when mapped.
...
**Not used on BRS hub ADHD dropdowns:**

- `### Dietary and lifestyle context` — diet and lifestyle live in hub **Dietary and Lifestyle Levers**; future TAs may add TA-specific dietary notes in their own dropdowns when mapped
...
- [ ] §2 prose cites only ADHD-focused studies (architecture pointer sentence allowed)  
- [ ] Translational closing paragraph present in §2  
