...
export const HUB_KC_SECTION_INTRO = {
  ...
  BRS5:
    "Gut–brain communication is shaped long before dysbiosis becomes clinically obvious. The Key Constraints identify the shared fermentable-fibre and polyphenol/plant-diversity inputs that microbial ecology, SCFA signalling and gut–brain interface stability depend upon. Dietary Guidance then builds on these shared requirements by showing how foods, dietary patterns and eating behaviours influence the wider biology of enteric and neuroimmune regulation.",
  BRS6:
