/**
 * Functional descriptors under mechanism page titles.
 * The title names the mechanism; the functional descriptor explains its biological role.
 */
export const MECHANISM_FUNCTIONAL_DESCRIPTORS = {
  // ——— Rewrites (too technical / redundant) ———
