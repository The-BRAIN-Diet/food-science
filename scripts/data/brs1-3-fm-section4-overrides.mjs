...
export const FM_NARRATIVE_42_OVERRIDES = {
  "BRS1(FM1)": `Together, substrate availability, meal-level LAT1 transport bias, and downstream noradrenergic and serotonergic signalling operationalise BRS1(FM1) as coordinated meal-level monoaminergic control.
